...
def processArchive():
    fields = ['Region','ANF','Cell','Band',' TIM_DISP_COUNTER_SYSTEM (%)',' TIM_VOLUME_DADOS_DLUL_ALLOP (KB)',' TIM_VOLUME_DADOS_DLUL_TIM (KB)',' TIM_TRAFEGO_VOZ_ALLOP (E)',' TIM_TRAFEGO_VOZ_TIM (E)']
    ...
    frameSI['SITE'] = frameSI['CELL'].str[:-1]
